...
It then fetch the data available for 227 second windows for 2 weeks starting from Feb 4,2013 for the time window of 8am to 5pm for all the users.
...
# # There are 142 windows of 227 seconds created per day. So the above optimization reduced 5 * 142 loops.
...
def create_time_slice(files,fname):
    ...
    for t in range(5): # There are 5 days in a week
        ...
        for x in range(142): # there are 142 227 second windows in a day
            first1=start_val1+x*227000 # adding 227 sec
            second1=start_val1+(x+1)*227000 # adding 227 sec
            first2=start_val2+x*227000 # adding 227 sec
            second2=start_val2+(x+1)*227000 # adding 227 sec
